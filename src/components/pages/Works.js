...
import instrument from '../../images/appScreenShot.png'
    ...
    return (
        <div className="projects" style={styles}>
            ...
            <div className="project">
                <h3>Play It Again Tune</h3>

                <a target="_blank" href="https://project3-playitagaintunes.herokuapp.com/">
                    <img src={instrument} alt="instruments"/>
                </a>
                <a target='_blank' href='https://github.com/thutuephan/Project3-PlayItAgainTunes'>
                <button className='code' >Source Code</button>
                </a>
                <p className="description"> This MERN application allows a user to select their favourite items, add the item/items to shopping cart, and check out. Tools and technologies used include MongoDB, React.js, Reduct, Express.js, Node.js. 
                </p>
